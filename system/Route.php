...
$confirm_uri = "/report/report/confirm";
$allowip="::1 localhost 213.80.197.198 95.141.192.26 213.80.220.169 127.0.0.1/8 88.147.242.9 95.141.196.238 95.141.192.3 95.31.32.72 95.141.192.88 77.94.195.65 88.147.142.43 176.15.127.14 109.167.136.196 188.235.146.51 88.147.242.207 83.22.104.91 188.227.28.30 78.29.115.138";
$pos = strpos($allowip, $clientIP);
$confirm_access = strpos($_SERVER['REQUEST_URI'], $confirm_uri);
if($confirm_access===false &&  $pos === false){
